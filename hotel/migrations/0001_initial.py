# Generated by Django 5.0 on 2025-03-10 18:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Upload a high-quality image of the hotel', upload_to='hotels/%Y/%m/%d/', verbose_name='Image')),
        ...
        migrations.CreateModel(
            name='Room',
            fields=[
                ('room_id', models.CharField(help_text='Unique identifier for the room', max_length=10, primary_key=True, serialize=False, unique=True, verbose_name='Room ID')),
                ...
                ('seasonal_pricing', models.JSONField(default=dict, help_text='Price variations based on season', verbose_name='Seasonal Pricing')),
                ('additional_fees', models.JSONField(default=dict, help_text='Extra charges for additional services', verbose_name='Additional Fees')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(help_text='Upload a high-quality image of the room', upload_to='rooms/%Y/%m/%d/', verbose_name='Image')),
                ('caption', models.CharField(blank=True, help_text='Optional description of the image', max_length=255, verbose_name='Caption')),
